...
pickle.dump(fits, open("pickles/results_TF3_v2_9p_fits.p", "wb"), protocol=4)
pickle.dump(thresholds, open("pickles/results_TF3_v2_9p_thresholds.p", "wb"), protocol=4)
print('fitnesses:')
print(fits)
